...
<nav class="navbar navbar-expand-lg" style="background-color: #54B435 ;" id="navbar">
    ...
    <div>
        ...
        <section class="p-3" id="main-content">
          ...
          <!--HALAMAN STATUS-->
          <div class="tabel">
          <h1 style="margin-left: 100px; margin-top: 55px;">SEMUA ADUAN MASYARAKAT</h1>
          <?php 
            $result = tampil_data();          
                if($result){
          ...
          <table class='table'>
             <thead class="table-dark">
              ...
              <?php
              $query = mysqli_query($koneksi, "SELECT * FROM lapor ORDER BY id_lapor");
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <img src="../assets/img<?= $row['pict']; ?>" width="100px"><br>
                          Foto dari petugas <br>

                          <img src="../assets/img<?= $row['pict_after']; ?>" ><br>
                        </div>
                      </div>
